...
public class AdminBoardServiceImpl implements AdminBoardService {
    ...
    public int deleteBoardMaster(Map<String, Object> paramMap) {
        ...
        adminMapper.deleteBoardCommentWithBoardMaster(paramMap);
        adminMapper.deleteBoard(paramMap);
        result = adminMapper.deleteBoardMaster(paramMap);
...
//            if(adminMapper.updateOriginalQna(paramMap) == 1){
    ...
    public int updateQna(MultipartFile[] files, Qna qna, HttpServletRequest request) {
        ...
        if(files != null){
            ...
            // DB에 파일 저장
            qna.setAttachFileIdx(fileUtil.updateFile(fileList,qna.getAttachFileIdx()));
        }
