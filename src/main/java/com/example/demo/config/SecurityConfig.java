...
//                .antMatchers("/login/member/**").hasRole("MANAGER") // authenticated() - 인증된 유저만 접근을 허용
                ...
                .antMatchers("/board/move").hasAnyRole("SYSTEM","ADMIN","MANAGER")
//                .antMatchers("/adm/**").hasAnyRole("SYSTEM","ADMIN","MANAGER")
...
//                .anyRequest().authenticated() // 그 외의 모든 요청은 인증된 사용자만 접근가능
                ...
                .csrf().ignoringAntMatchers("/sendVerificationMail") //csrf 예외 처리
                        ...
                        .ignoringAntMatchers("/adm/popup/**") //csrf 예외 처리
                        .ignoringAntMatchers("/qna/**") //csrf 예외 처리
                        .ignoringAntMatchers("/forgetPwd") //csrf 예외 처리
